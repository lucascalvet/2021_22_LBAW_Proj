...
<section class="bg-info" id="profile">

<div class="container vh-100">
      <h1 class="text-light pt-5">Editing Profile</h1>
      <div class="row gx-5">
          <div class="col-6">
          ...
          <div class="col-6 text-center">
            ...
            <h3 class="mt-3 mb-3">Profile picture</h3>
            ...
            <h3 class="mt-4 mb-3">Cover picture</h3>
            <div class="bg-white rounded-3 p-5">
              <i class="bi bi-images"></i>
            </div>

            <h4 class="mt-4 mb-3">Interests</h4>
            <div>
