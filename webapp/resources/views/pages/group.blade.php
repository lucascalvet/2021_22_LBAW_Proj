...
<div class="vh-100 row bg-dark text-white" style="padding: 0em; margin: 0em; overflow: visible;">
            ...
            <div style="height: auto; max-height: 15em; overflow-y: auto;">
                <table class="table table-hover table-dark">
                    ...
                    <tbody>
                        ...
                        @if ($mod->id != 1)
                        <tr>
                            <td><a href="{{ route('profile', ['user' => $mod->id])}}">{{ $mod->username }}</a></td>
                        </tr>
                        @endif
                        @endforeach
                    </tbody>
    ...
    <div class="col-8">
        ...
        <div class="d-flex justify-content-center mt-3 mb-3">
            @if ($group->moderators->contains($user))
            <a href="{{ $link_edit }}"><button type="button" class="btn btn-outline-secondary btn-lg bg-dark text-white me-3">Edit Group</button></i></a>
