          ...
          <div class="row">
            ...
            <div class="d-flex flex-wrap justify-content-evenly">
              ...
              <div id="a-remove-friend-div-{{$friend->id}}" class="d-flex mx-2 pb-2">
                ...
                <a id="a-remove-friend-{{$friend->id}}" class="a-remove-friend btn btn-primary ms-2 py-0 px-1 border-0" title="Unfriend" data-bs-toggle="tooltip" data-bs-placement="bottom" style="color:black; background-color:grey;">
        ...
        <div class="row mb-2">
          ...
          <div class="d-flex flex-wrap justify-content-evenly">
            ...
            <div id="a-remove-friend-div-{{$friend->id}}" class="d-block mx-2 pb-2">
              <a hre="{{ route('profile', ['user' => $friend->id]) }}">
