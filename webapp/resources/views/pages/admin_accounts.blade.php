...
<div class="container vh-100 w-50 overflow-hidden">
    <div class="row">
        <div class="d-flex align-items-end mb-4 ps-0">
            ...
            <h3 class="me-4 mt-5 me-auto">Accounts</h3>
            <a href="\admin">
        ...
        <div class="col">
            ...
            <div class="row mb-5">
                <div class="d-flex px-0 justify-content-between align-items-stretch">
                    <button type="button" class="w-50 btn btn-warning me-4">Ban Account</button>
                    <button type="button" class="w-50 btn btn-success">Unban Account</button>
                </div>
            </div>
            <div class="row mb-5">
                <button type="button" class="btn btn-danger w-100">Remove Account</button>
            </div>
        </div>
