                ...
                <form method="POST" action="{{ route('post.edit', $post) }}" enctype="multipart/form-data">
                  ...
                  <div class="form-floating mb-2">
                    <input type="text" id="title" name="title" class="form-control form-control-lg"
                      placeholder="* Post Title" autofocus value="{{ $post->title }}" required>
                  ...
                  <div class="form-floating mb-2">
                    <input type="text" id="description" name="description" class="form-control form-control-lg"
                      placeholder="* Description" value="{{ $post->description }}" required>
                  ...
                  <div class="form-floating mb-2">
                    <input type="file" accept="image/*,video/*" id="media" name="media"
                      class="form-control form-control-lg" placeholder="Media" value="{{ $post->media }}">
