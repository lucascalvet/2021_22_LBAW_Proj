...
CREATE TABLE friends (
   id_user1 INTEGER NOT NULL REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE,
   id_user2 INTEGER NOT NULL REFERENCES users(id) ON UPDATE CASCADE ON DELETE CASCADE,
...
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday, description) VALUES (1, 'anonymous', 'Anonymous User', 'support@socialup.com', '', 'img/profile_pic.png', 'img/cover_pic.jpg', NULL, 1, '1970-1-1', 'A random test user description');
...
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (2, 'Prabovers', 'David N. Thomas', 'user@example.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '561-883-6567', 12, '1988-2-13'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (3, 'Rivinquister', 'Robert A. West', 'RobertAWest@armyspy.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '616-261-7167', 2, '1962-10-20'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (4, 'Hoppled91', 'Isaac K. Spencer', 'IsaacKSpencer@dayrep.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '914-964-9238', 2, '1991-8-6'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (5, 'Ingled91', 'Tim K. Gutierrez', 'TimKGutierrez@teleworm.us', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '270-379-5170', 3, '1991-10-28'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (6, 'Daimpas1985', 'William T. Hancock', 'WilliamTHancock@jourrapide.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '504-491-4903', 3, '1985-7-13'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (7, 'Forneved', 'Paul J. Gillen', 'PaulJGillen@jourrapide.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '203-509-4665', 4, '1947-10-27'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (8, 'Stoonce', 'Clarence S. Catron', 'ClarenceSCatron@teleworm.us', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '406-775-1564', 4, '1995-4-20'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (9, 'Walcon', 'Susanne M. Miller', 'SusanneMMiller@dayrep.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '631-444-4388', 5, '1986-11-29'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (10, 'Museltole', 'John K. Shuman', 'JohnKShuman@jourrapide.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '919-484-3756', 5, '1983-9-22'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (11, 'Hatecrable2000', 'Jeniffer J. Parsons', 'JenifferJParsons@teleworm.us', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '814-845-9721', 6, '2000-3-1'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (12, 'Dights1956', 'Kim B. McClain', 'KimBMcClain@teleworm.us', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '702-243-7350', 6, '1956-12-17'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (13, 'Examated', 'Casey J. Russo', 'CaseyJRusso@jourrapide.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '314-765-9362', 7, '1996-8-24'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (14, 'Thenly', 'Ines C. Yancey', 'InesCYancey@jourrapide.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '203-736-5651', 7, '1992-4-27'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (15, 'Caus1973', 'Patricia E. Horton', 'PatriciaEHorton@teleworm.us', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '336-750-8290', 8, '1973-7-23'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (16, 'Lighbothe', 'Cathy F. McBride', 'CathyFMcBride@jourrapide.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '801-667-2817', 8, '1958-8-15'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (17, 'Hatumer', 'Betty R. Seamon', 'BettyRSeamon@rhyta.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '302-570-5766', 9, '1985-11-8'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (18, 'Buls1950', 'Silvia P. Broadhurst', 'SilviaPBroadhurst@teleworm.us', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '781-727-1458', 9, '1950-2-21'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (19, 'Ourne2001', 'Scott K. Goode', 'ScottKGoode@teleworm.us', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '352-431-8723', 10, '2001-4-13'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (20, 'Miltary58', 'Carmela H. Choi', 'CarmelaHChoi@teleworm.us', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '360-697-3591', 11, '1958-6-2'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (21, 'Evernshould', 'Evelyn M. Dudley', 'EvelynMDudley@rhyta.com', '$2y$10$HfzIhGCCaxqyaIdGgjARSuOKAcm1Uy82YfLuNaajn6JrjLWy9Sj/W', 'img/profile_pic.png', 'img/cover_pic.jpg', '561-265-2290', 12, '1956-3-4'); --1234
INSERT INTO users (id, username, name, email, hashed_password, profile_picture, cover_picture, phone_number, id_country, birthday) VALUES (22, 'admin', 'SU Admin', 'admin@socialup.com', '$2y$10$EOAidWrMdRctCQLsICSVXuLvTEquByvzlAMbd31Vm7io4r3O5xJy6', 'img/profile_pic.png', 'img/cover_pic.jpg', '931234567', 11, '1990-5-7'); --admin
SELECT setval('users_id_seq', (SELECT max(id) FROM users));
